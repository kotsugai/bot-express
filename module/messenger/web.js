...
module.exports = class MessengerWeb {
    ...
    _send_single_message(event, to, message){
        ...
        return Promise.resolve();
        //socket.to("test").emit('bot_message', 'This is ChatEngin.');
        /*
    ...
    static compile_message(message_format, message_type, message){
        message_format = "web";
        return MessengerWeb[`_compile_message_from_${message_format}_format`](message_type, message);
       // return MessengerWeb[`_compile_message_from_web_format`](message_type, message);
    }

    static _compile_message_from_web_format(message_type, message){
    ...
    static _compile_message_from_viber_format(message_type, message){
        debug(`Message type is Viber's ${message_type} and it is not supported in Facebook.`);
        compiled_message = {
           type: "text",
           text: `*Message type is Viber's ${message_type} and it is not supported in Facebook.`
        }
        return compiled_message;
    }
